...
?>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["instrument_id"])) {
            ...
            if ($result->num_rows == 1) {
                ...
                <form action="updatefunc.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $instrument_id; ?>">
                    <div class="form-group">
                        <label for="instrument_name">Instrument Name:</label>
                        <input type="text" class="form-control" id="instrument_name" name="instrument_name" value="<?php echo $row['instrument_name']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="instrument_details">Instrument Details:</label>
                        <textarea class="form-control" id="instrument_details" name="instrument_details" rows="4" required><?php echo $row['instrument_details']; ?></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <img src="<?php echo $row['instrument_img']; ?>" alt="Current Image" width="200">
                    </div>
                    <div class="form-group">
